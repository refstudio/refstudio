...
describe('PasswordInput', () => {
  it('should start as password toggle to text on "SHOW"/"HIDE" icon click', async () => {
    ...
    expect(screen.getByPlaceholderText<HTMLInputElement>('input password').type).toBe('password');

    await user.click(screen.getByTitle('Show'));
    expect(screen.getByPlaceholderText<HTMLInputElement>('input password').type).toBe('text');
