...
describe('PrimarySideBar', () => {
  it('should display Explorer and References icons', () => {
    render(<SideBar activePane="Explorer" onClick={noop} onSettingsClick={noop} />);
  ...
  it('should display active icon with 100% opacity', () => {
    render(<SideBar activePane="References" onClick={noop} onSettingsClick={noop} />);
    expect(screen.getByRole('menubar')).toBeInTheDocument();
  ...
  it('should call onClick with pane name', async () => {
    const fn = vi.fn();
    render(<SideBar activePane="References" onClick={fn} onSettingsClick={noop} />);
  ...
  it('should call onSettingsClick with click in the settings icon', async () => {
    ...
    render(<SideBar activePane="References" onClick={noop} onSettingsClick={settingsFn} />);
