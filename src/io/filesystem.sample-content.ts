export const INITIAL_CONTENT = `
  ...
  <notionblock type="collapsible" collapsed="false">
    ...
    <notionblock type="collapsible" collapsed="true">
      <p>collapsible 1.2</p>
    </notionblock>
  </notionblock>
