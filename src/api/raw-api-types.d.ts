...
export interface components {
  schemas: {
    ...
    ChatResponse: {
      ...
      message: string;
      choices: components['schemas']['ChatResponseChoice'][];
    };
    /** ChatResponseChoice */
    ChatResponseChoice: {
      index: number;
    ...
    RewriteRequest: {
      text: string;
      /** @default concise */
      manner?: components['schemas']['RewriteMannerType'];
      /** @default 1 */
      n_choices?: number;
      /** @default 0.7 */
      temperature?: number;
    ...
    RewriteResponse: {
      status: components['schemas']['ResponseStatus'];
      message: string;
      choices: components['schemas']['RewriteChoice'][];
    };
    /** S2SearchResult */
    S2SearchResult: {
      title?: string;
    ...
    SearchResponse: {
      status: components['schemas']['ResponseStatus'];
      message: string;
      results: components['schemas']['S2SearchResult'][];
    };
    ...
    SettingsSchema: {
       ...
       * }
       */
      openai?: components['schemas']['OpenAISettings'];
      /**
       * @default {
       *   "logging": {
       *     "enable": false,
       ...
       * }
       */
      sidecar?: components['schemas']['SidecarSettings'];
    };
    /** SidecarSettings */
    SidecarSettings: {
      /**
